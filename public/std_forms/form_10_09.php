...
<head>
    ...
    <title>Proforma 10.09 - DOT Clearance Certificate</title>
    <style>
...
<div class="a4-page">
    ...
    <div class="main-heading">
        PROFORMA-10.09<br><br>
        CLEARANCE CERTIFICATE REGARDING COMPLETION OF WORKS
    </div>
    ...
    <div class="body-text">
        The DOT has completed all its works in connection with electrification of the above-mentioned
        section at 25 KV AC and has no objection to the Railway energizing the OHE with 25 KV AC in the
        above section.
    </div>
