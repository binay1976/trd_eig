...
<head>
    ...
    <title>SP-120 KV LIGHTNING ARRESTER INSPECTION</title>
...
<div class="max-w-6xl mx-auto px-4">
    ...
    <div style="display:inline-block; background:#003366; color:#fff;
        ...
        <div><span style="opacity:.75;font-size:11px;letter-spacing:.5px;">FORM NO</span>
             &nbsp;<strong style="font-size:15px;">SP-02</strong></div>
        <div style="font-size:12px; opacity:.9;">SP-120 KV LIGHTNING ARRESTER INSPECTION</div>
    </div>
<!-- Page Title -->
    <div class="mb-6">
