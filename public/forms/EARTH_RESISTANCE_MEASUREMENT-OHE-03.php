...
<head>
    ...
    <title>Earth Resistance Measurement Form</title>
    <!-- Tailwind CSS -->
...
<body class="bg-gray-100 min-h-screen">
    ...
    <div style="display:inline-block; background:#003366; color:#fff;
        ...
        <div><span style="opacity:.75;font-size:11px;letter-spacing:.5px;">FORM NO</span>
             &nbsp;<strong style="font-size:15px;">OHE-03</strong></div>
        <div style="font-size:12px; opacity:.9;">OHE-EARTH RESISTANCE MEASUREMENT REPORT</div>
    </div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <div class="mb-6">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">
            Earth Resistance Measurement Report
        </h1>
        <p class="text-sm text-gray-500 mt-1">
            Enter the earth resistance and mast parameters. All marked fields are mandatory.
        </p>
    </div>
    ...
    <form method="POST" action="/trd_eig/public/save_form.php?unique_form_id=<?= htmlspecialchars($_GET['unique_form_id'] ?? '') ?>" class="space-y-5">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h2 class="text-base sm:text-lg font-semibold text-gray-800 mb-4">Location Details <span class="text-red-500">*</span></h2>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h2 class="text-base sm:text-lg font-semibold text-gray-800 mb-4">Structural Parameters & Leaning <span class="text-red-500">*</span></h2>
