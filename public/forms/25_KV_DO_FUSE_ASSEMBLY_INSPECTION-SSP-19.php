...
<head>
    ...
    <title>SSP-25 KV DO FUSE ASSEMBLY INSPECTION</title>
...
<div class="max-w-6xl mx-auto px-4">
    ...
    <div style="display:inline-block; background:#003366; color:#fff;
        ...
        <div><span style="opacity:.75;font-size:11px;letter-spacing:.5px;">FORM NO</span>
             &nbsp;<strong style="font-size:15px;">SSP-19</strong></div>
        <div style="font-size:12px; opacity:.9;">SSP-25 KV DO FUSE ASSEMBLY INSPECTION</div>
    </div>
<div class="mb-6">
